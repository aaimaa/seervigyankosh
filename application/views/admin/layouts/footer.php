  ...
  <footer class="main-footer">
        <strong>Copyright &copy; <?= date('Y');?> Seervi Gyankosh.</strong>
        All rights reserved.
  </footer>
</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.css.map" type="text/javascript"></script>
<script src="<?php echo base_url('assets/dist/js/jQuery.print.min.js')?>"></script>
</body>
</html>
