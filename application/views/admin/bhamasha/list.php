        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo base_url('admin/bhamashah/add');?>" class="btn btn-primary float-sm-right">Add New</a>
...
<script>
  var table = $('#example2').DataTable({
    ...
    "responsive": true,
    "ajax": {
      url : "<?php echo base_url('admin/bhamashah-list'); ?>",
      type : 'GET'
    },
  });
  ...
  function confirmDelete(id){
    ...
    function(){
      $.ajax({
        url: "<?php echo base_url('admin/bhamashah/delete')?>",
        type: "GET",
        data: {"id":id,"table": 'bhamashah'},
        dataType:"json",
        success: function () {
