            ...
            <ul class="faq pl-sm-4 pl-3">
              <li class="item1 mt-sm-4 mt-3 pl-2">
                <a href="#" title="click here"
                  ...
                  Donec tempor vehicula ipsum nec ?</a
                >
                <ul>
              ...
              <li class="item2 mt-sm-4 mt-3 pl-2">
                <a href="#" title="click here"
                  >The standard Lorem Ipsum passage Etiam faucibus viverra
                  libero vel efficitur. Ut semper nisl ut laoreet ultrices ?</a
                >
                <ul>
                  <li class="subitem1 mt-3">
                    <p>
              ...
              <li class="item3 mt-sm-4 mt-3 pl-2">
                <a href="#" title="click here"
                  >Consectetuer adipiscing elit Etiam faucibus viverra libero
              ...
              <li class="item6 mt-sm-4 mt-3 pl-2">
                <a href="#" title="click here"
                  >Voluptas sit aspernatur aut Ut semper nisl ut laoreet
                  ultrices ?</a
                >
                <ul>
                  <li class="subitem1 mt-3">
