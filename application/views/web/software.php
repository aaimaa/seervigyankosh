		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row cource-list-agile pt-4">
				<div class="col-lg-7 agile-course-main">
					<div class="w3ls-cource-first">
						<img src="<?php echo base_url('assets/front/images/1.png"');?> alt="" class="img-fluid img-poiscour mx-auto d-block mt-2"></img>
				...
				<div class="col-lg-5 agile-course-main-2 mt-4">
					<img src="<?php echo base_url('assets/front/images/am2.jp');?>g" alt="" class="img-fluid">
				</div>
			...
			<div class="row cource-list-agile cource-list-agile-2">
				<div class="col-lg-5 agile-course-main-3 mt-4">
					<img src="<?php echo base_url('assets/front/images/n3.jpg');?>" alt="" class="img-fluid">
				</div>
				<div class="col-lg-7 agile-course-main text-right">
					<div class="w3ls-cource-first">
						<img src="<?php echo base_url('assets/front/images/2.png"');?> alt="" class="img-fluid img-poiscour mx-auto d-block mt-2"></img>
						<div class="px-md-5 px-4  pb-md-5 pb-4">
			...
			<div class="row cource-list-agile pt-4">
				...
				<div class="col-lg-5 agile-course-main-2 mt-4">
					<img src="<?php echo base_url('assets/front/images/am3.jp');?>g" alt="" class="img-fluid">
				</div>
				<div class="buttons-w3ls">
					<a class="btn button-cour-w3ls text-white" href="course_details.html" role="button">Learn More</a>
					<a class="btn bg-dark text-white" href="form.html" role="button">Apply Now</a>
			...
			<div class="row cource-list-agile cource-list-agile-2">
				<div class="col-lg-5 agile-course-main-3 mt-4">
					<img src="<?php echo base_url('assets/front/images/am4.jp');?>g" alt="" class="img-fluid">
				</div>
				<div class="col-lg-7 agile-course-main text-right">
					<div class="w3ls-cource-first">
						<img src="<?php echo base_url('assets/front/images/2.png"');?> alt="" class="img-fluid img-poiscour mx-auto d-block mt-2"></img>
			...
			<div class="row cource-list-agile pt-4">
				...
				<div class="col-lg-5 agile-course-main-2 mt-4">
					<img src="<?php echo base_url('assets/front/images/n2.jpg');?>" alt="" class="img-fluid">
				</div>
				<div class="buttons-w3ls">
					<a class="btn button-cour-w3ls text-white" href="course_details.html" role="button">Learn More</a>
					<a class="btn bg-dark text-white" href="form.html" role="button">Apply Now</a>
			...
			<div class="row cource-list-agile cource-list-agile-2">
				<div class="col-lg-5 agile-course-main-3 mt-4">
					<img src="<?php echo base_url('assets/front/images/n1.jpg');?>" alt="" class="img-fluid">
				</div>
				<div class="col-lg-7 agile-course-main text-right">
					<div class="w3ls-cource-first">
						<img src="<?php echo base_url('assets/front/images/2.png"');?> alt="" class="img-fluid img-poiscour mx-auto d-block mt-2"></img>
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="language.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c1.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
				...
				<div class="col-lg-4 col-news-top text-center my-lg-0 my-sm-5 my-4">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="communication.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c2.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="business.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c3.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="software.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c4.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
				...
				<div class="col-lg-4 col-news-top text-center  my-lg-0 my-sm-5 my-4">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="social_media.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c6.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="photography.html">
							<div class="img">
								<img src="<?php echo base_url('assets/front/images/c5.jpg');?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
