        ...
        <div class="row inner_sec_info pt-md-4">
          ...
          <div class="col-lg-8 single-left">
            <div class="single-left1">
              <img src="<?php echo base_url('assets/front/images/banner');?>3.jpg" alt=" " class="img-fluid" />
              ...
              <h5 class="card-title">
                <a href="single.html" class="text-dark"
                  >Sed ut perspiciatis unde omnis iste natus error sit facilisis
                  erat posuere erat</a
                >
              </h5>
              <p>
            ...
            <div class="admin p-4 my-4">
              <p>
                <i class="fas fa-quote-left mr-2"></i>nibh eu consequat magna
                ipsum ac ex. Nulla iaculis tincidunt elit, tortor luctus sit
                amet. Morbi in porta dolor. Morbi eget dui elit. consequat magna
                ipsum ac ex, Nulla iaculis consequat magna ipsum ac ex Nulla
                iaculis.
              ...
              <div class="comments-grids mt-4">
                <div class="row comments-grid">
                  <div class="col-3 comments-grid-left">
                    <img
                      src="<?php echo base_url('assets/front/images/t1.jpg');?>"
                      alt=" "
                ...
                <div class="row comments-grid my-4">
                  <div class="col-3 comments-grid-left">
                    <img
                      src="<?php echo base_url('assets/front/images/t2.jpg');?>"
                      alt=" "
                      class="img-thumbnail rounded-circle"
                    />
                  </div>
                ...
                <div class="row comments-grid">
                  <div class="col-3 comments-grid-left">
                    <img
                      src="<?php echo base_url('assets/front/images/t3.jpg');?>"
                      alt=" "
                      class="img-thumbnail rounded-circle"
                    />
                  </div>
          ...
          <div class="col-lg-4 event-right mt-lg-0 mt-sm-5 mt-4">
            <div class="event-right1">
              ...
              <div class="tags mt-4 p-4 border">
                ...
                <ul class="mt-4">
                  <li>
                    <a href="course_details.html" class="text-dark border"
                      >Designs</a
                    >
                  </li>
                  <li>
